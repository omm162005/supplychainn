                    ...
                    <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
                         ...
                         <form onSubmit={(e) => e.preventDefault()}>
                            <div className="relative mt-3">
                                <input
                                    ...
                                    outline-none border focus:border-indigo-400 shadow-sm rounded-lg"
                            ...
                            <button
                                ...
                                className="block w-full mt-3 py-3 px-4 font-medium text-sm text-center text-white bg-indigo-600 hover:bg-indigo-700
                        ...
                        {singleShipmentData == undefined ? (
                          ...
                          <div className="text-left">
                            ...
                            <p>Paid: {singleShipmentData.isPaid ? "Yes" : "No"}</p>
                          </div>
                        )}
                    </div>
                </div>
