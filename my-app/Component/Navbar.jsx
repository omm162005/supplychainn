...
import { Nav1, Nav2, Nav3 } from "../Component/index";
export default () => {
...
>
  <div className = "gap-x-14 items-center max-w-screen-2xl mx-auto px-4 md:flex md:px-8">
    ...
    <div className={`flex-1 items-center mt-8 md:mt-0 md:flex ${state ? "block" : "hidden"}`}>
     <ul className="flex flex-col md:flex-row justify-center items-center space-y-3 md:space-y-0 md:space-x-6">
      ...
      <div className=" flex-1 gap-x-6 items-center justify-end mt-6 space-y-6 
         md:flex space-y-0 md:mt-0">
        {currentUser ? (
          <p className="flex items-center gap-x-1 py-2 px-4
