...
function createShipment(address _receiver,uint256 _pickupTime, uint256 _distance,uint256 _price) public payable{
     ...
     require(msg.value== _price,"Payment value must match the price");
    ...
    function getShipment(address _sender,uint256 _index) public view returns(Shipment memory){
...
function getAllTrasaction() public view returns(TypeShipment[] memory){
